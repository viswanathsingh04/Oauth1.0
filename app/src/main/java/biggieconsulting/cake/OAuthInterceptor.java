...
import OauthConstants.ParameterList;
...
public class OAuthInterceptor implements Interceptor {
    ...
    * */
    ...
    private static final String OAUTH_SIGNATURE_METHOD_VALUE = "HMAC-SHA256";
    ...
    public Response intercept(@NonNull Chain chain) throws IOException {
        ...
        if(original.url().encodedQuery()!=null) {
            generatedBaseString = original.url().encodedQuery() + "&oauth_consumer_key=" + consumerKey + "&oauth_nonce=" + nonce + "&oauth_signature_method=HMAC-SHA256&oauth_version=1.0";
        ...
        {
            generatedBaseString = "oauth_consumer_key=" + consumerKey + "&oauth_nonce=" + nonce + "&oauth_signature_method=HMAC-SHA256&oauth_version=1.0";
